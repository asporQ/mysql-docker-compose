                    ...
                    <form method="POST" action="{{ route('diary.store') }}">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="date" id="date" name="date"
                                class="mt-1 block w-full border-gray-300 rounded-md shadow-sm dark:bg-gray-700 dark:text-black"
                                ...
                                <div class="flex items-center mb-4">
                                    ...
                                    <div class="ml-4 hidden flex-1" id="intensity_container_{{ $emotion->id }}">
                                        <input type="number" name="intensity[{{ $emotion->id }}]"
                                            class="w-full border-gray-300 rounded-md shadow-sm dark:bg-gray-700 dark:text-black dark:border-gray-600 focus:ring-indigo-500 focus:border-indigo-500"
